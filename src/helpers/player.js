...
const PLAYER_FRAME_COUNT = 2; // 2 images change between images to make it look like its running
...
export function setPlayerLose() {
  playerElem.src = `./images/playerJumps.png`;
}
...
function handleRun(delta, speedScale) {
    ...
    if (currentFrameTime >= FRAME_TIME) {
        ...
        playerElem.src = `./images/playerRuns${playerFrame}.png`;
